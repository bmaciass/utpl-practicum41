/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bb788fff0ce6f42acebeb8bb850adc91)
...
declare namespace Cloudflare {
  interface Env {
    ...
    PRIVATE_JWK:
      | '{"key_ops":["sign"],"ext":true,"crv":"Ed25519","d":"c1gkkvWRMaDKPKG8C7Zwp--Zvov1O3qj05cbdr5BEUo","x":"d0giNKtlIrSFkNsDmF4lZiynvxKlJVxGmPXaeW5rqgc","kty":"OKP"}'
      | ''
    PUBLIC_JWK:
      | '{"key_ops":["verify"],"ext":true,"crv":"Ed25519","x":"d0giNKtlIrSFkNsDmF4lZiynvxKlJVxGmPXaeW5rqgc","kty":"OKP"}'
      | ''
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
      Pick<
        Cloudflare.Env,
        'ENVIRONMENT' | 'DATABASE_URL' | 'PRIVATE_JWK' | 'PUBLIC_JWK'
      >
    > {}
}
