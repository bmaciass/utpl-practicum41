/**
 * Usage: This script will recreate the src/schema/pothos/types/index.ts that will be used to create the type defs by generate
 */
...
const TYPEDEFS_DIR = path.resolve(ROOT_DIR, 'src/presentation/graphql/types')
