...
const documents: Documents = {
    ...
    "\n  mutation Goal_useCreateGoal($data: CreateGoalDataInput!) {\n    goal {\n      create(data: $data) {\n        uid\n        name\n        description\n        active\n      }\n    }\n  }\n": types.Goal_UseCreateGoalDocument,
    "\n  mutation Goal_useDeleteGoal($input: DeleteGoalInput!) {\n    goal {\n      delete(input: $input)\n    }\n  }\n": types.Goal_UseDeleteGoalDocument,
    "\n  query Goal_useGetGoal($uid: String!) {\n    goal {\n      one(uid: $uid) {\n        uid\n        name\n        description\n        active\n      }\n    }\n  }\n": types.Goal_UseGetGoalDocument,
    "\n  query Goal_useGoalList(\n    $institutionalObjectiveUid: String!\n    $active: Boolean!\n    $search: String!\n    $limit: Int!\n    $offset: Int!\n  ) {\n    goal {\n      list(\n        filters: {\n          institutionalObjectiveUid: $institutionalObjectiveUid\n          active: $active\n          search: $search\n        }\n        limit: $limit\n        offset: $offset\n      ) {\n        records {\n          uid\n          name\n          description\n          active\n        }\n      }\n    }\n  }\n": types.Goal_UseGoalListDocument,
    "\n  mutation Goal_useUpdateGoal(\n    $where: UpdateGoalWhereInput!\n    $data: UpdateGoalDataInput!\n  ) {\n    goal {\n      update(where: $where, data: $data) {\n        uid\n        name\n        description\n        active\n      }\n    }\n  }\n": types.Goal_UseUpdateGoalDocument,
