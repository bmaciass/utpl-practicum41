...
const InstitutionalPlansSection = () => {
  ...
  if (isEmpty(institutions)) {
    return <Paragraph>No hay planes institucionales cargados</Paragraph>
  }
...
export default function Index() {
  return <ClientOnly>{() => <InstitutionsPage />}</ClientOnly>
}
