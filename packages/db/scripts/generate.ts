/**
 * Usage: This script will recreate the src/pothos/types/index.ts that will be used to create the type defs by generate
 */
...
const DIRECTORIES = ['tables'] // TODO: Include relations later
